...
export const Resume = () => {
  ...
  return (
    <div className="flex justify-center items-center flex-col w-full overflow-hidden">
      ...
      <div className="mt-16 sm:mt-32 w-full border-stone-400 border bg-stone-200 max-w-lg sm:max-w-3xl h-32 sm:h-60 rounded-t-4xl inset-shadow-sm flex place-content-center relative">
        <div className="max-w-xs sm:max-w-lg shadow hover:shadow-2xl transition ease-in-out place-content-center justify-items-center hover:-translate-y-8 hover:rotate-1 absolute -bottom-30 cursor-pointer border border-stone-200 duration-200 -rotate-2 sm:rotate-0">
